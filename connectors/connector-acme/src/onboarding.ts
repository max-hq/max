...
const getTenant = InputStep.create({
  label: 'Acme tenant',
...
const getCreds = InputStep.after(getTenant, {
...
const verify = ValidationStep.after(getCreds, {
...
const selectWorkspace = SelectStep.after(verify, {
